...
func jsonDecode(alloc core.Allocator, args ...core.Object) (ret core.Object, err error) {
	if len(args) != 1 {
...
func jsonEncode(alloc core.Allocator, args ...core.Object) (ret core.Object, err error) {
	if len(args) != 1 {
...
func jsonIndent(alloc core.Allocator, args ...core.Object) (ret core.Object, err error) {
	if len(args) != 3 {
	...
	case *value.Bytes:
		...
		return alloc.NewBytes(dst.Bytes()), nil
	case *value.String:
		var dst bytes.Buffer
...
func jsonHTMLEscape(alloc core.Allocator, args ...core.Object) (ret core.Object, err error) {
	if len(args) != 1 {
