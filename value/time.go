...
func (o *Time) Method(vm core.VM, name string, args []core.Value) (core.Value, error) {
	...
	case "to_time":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_time", "0", len(args))
		}
		return core.ObjectValue(o), nil

	case "to_bool":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_bool", "0", len(args))
		}
		return core.BoolValue(o.IsTrue()), nil

	case "to_int":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_int", "0", len(args))
		}
		return core.IntValue(o.value.Unix()), nil

	case "to_string":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_string", "0", len(args))
		}
		return vm.Allocator().NewStringValue(o.value.String()), nil

	case "year":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.year", "0", len(args))
		}
		return core.IntValue(int64(o.value.Year())), nil

	case "month":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.month", "0", len(args))
		}
		return core.IntValue(int64(o.value.Month())), nil

	case "day":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.day", "0", len(args))
		}
		return core.IntValue(int64(o.value.Day())), nil

	case "hour":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.hour", "0", len(args))
		}
		return core.IntValue(int64(o.value.Hour())), nil

	case "minute":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.minute", "0", len(args))
		}
		return core.IntValue(int64(o.value.Minute())), nil

	case "second":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.second", "0", len(args))
		}
		return core.IntValue(int64(o.value.Second())), nil

	case "nanosecond":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.nanosecond", "0", len(args))
		}
		return core.IntValue(int64(o.value.Nanosecond())), nil

	case "unix":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.unix", "0", len(args))
		}
		return core.IntValue(o.value.Unix()), nil

	case "unix_nano":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.unix_nano", "0", len(args))
		}
		return core.IntValue(o.value.UnixNano()), nil

	case "week_day":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.week_day", "0", len(args))
		}
		return core.IntValue(int64(o.value.Weekday())), nil

	case "year_day":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.year_day", "0", len(args))
		}
		return core.IntValue(int64(o.value.YearDay())), nil

	case "month_name":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.month_name", "0", len(args))
		}
		return vm.Allocator().NewStringValue(o.value.Month().String()), nil

	case "week_day_name":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.week_day_name", "0", len(args))
		}
		return vm.Allocator().NewStringValue(o.value.Weekday().String()), nil

	case "to_utc":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_utc", "0", len(args))
		}
		return vm.Allocator().NewTimeValue(o.value.UTC()), nil

	case "to_local":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_local", "0", len(args))
		}
		return vm.Allocator().NewTimeValue(o.value.Local()), nil

	case "to_date_string":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_date_string", "0", len(args))
		}
		return vm.Allocator().NewStringValue(o.value.Format(time.DateOnly)), nil

	case "to_time_string":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_time_string", "0", len(args))
		}
		return vm.Allocator().NewStringValue(o.value.Format(time.TimeOnly)), nil

	case "to_date_time_string":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.to_date_time_string", "0", len(args))
		}
		return vm.Allocator().NewStringValue(o.value.Format(time.DateTime)), nil

	case "zone_offset":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.zone_offset", "0", len(args))
		}
	...
	case "zone_name":
		if len(args) != 0 {
			return core.UndefinedValue(), errs.NewWrongNumArgumentsError("time.zone_name", "0", len(args))
		}
		name, _ := o.value.Zone()
